...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("com.iuh.bookingcare.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("com.iuh.bookingcare.security.DomainUserDetailsService", "createSpringSecurityUser");
